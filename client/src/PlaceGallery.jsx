    ...
    return (
      <div className="absolute inset-0 text-white min-h-screen">
        <div className="bg-black p-8 grid gap-4 justify-center">
          <div>
            <h2 className="text-xl mr-36">Photos of {place.title}</h2>
            <button
              type="button"
              onClick={() => setShowAllPhotos(false)}
              className="fixed right-10 top-8 flex gap-1 py-2 px-4 rounded-2xl bg-white text-black shadow shadow-black"
            >
              <svg
